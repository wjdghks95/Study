...
import hello.dbconnection.itemservice.domain.QItem;
...
import static hello.dbconnection.itemservice.domain.QItem.item;

/**
 * Querydsl
 * Querydsl 사용 시 JPAQueryFactory 필요
 * JPAQueryFactory 는 JPQL 을 만들기 때문에 EntityManager 필요
 *
 * where
 *  - BooleanBuilder
 *  - BooleanExpression
