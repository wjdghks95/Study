...
import hello.validation.itemservice.domain.item.Item;
import hello.validation.itemservice.domain.item.ItemRepository;
...
/**
 * BindingResult 를 이용한 검증
 * addItemV1 - FieldError, ObjectError
 * addItemV2 - FieldError, ObjectError 의 rejectedValue 파라미터 사용
 * addItemV3 - FieldError, ObjectError 의 codes(메시지 코드) 와 arguments 사용
 * addItemV4 - rejectValue, reject
 * addItemV5 - Validator 분리 후 직접 호출
 * addItemV6 - @Validated 를 사용하여 WebDataBinder 에 등록한 검증기 실행
 */
@Slf4j
@Controller
...
//    @PostMapping("/add")
    public String addItem(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        ...
        if (item.getPrice() == null || item.getPrice() == null || item.getPrice() > 1000000) {
