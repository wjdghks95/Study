...
//        dao.setDataSource(dataSource);
        ...
        this.user1 = new com.example.test.User("user1", "유저1", "1234");
        this.user2 = new com.example.test.User("user2", "유저2", "1234");
        this.user3 = new com.example.test.User("user3", "유저3", "1234");
    }
    ...
    public void addAndGet() throws SQLException, ClassNotFoundException {
        ...
        com.example.test.User userget1 = dao.get(user1.getId());
